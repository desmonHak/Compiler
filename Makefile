...
C=gcc -O$(LEVEL_OPTIMIZACION) -fdiagnostics-color=always -masm=intel -std=c17 -Wall -Wextra -Wno-unused-parameter -Wno-implicit-fallthrough -Wno-type-limits -Wno-unused-variable -Wno-pointer-sign
