 ...
 *
 * Redistribution and use in source and binary forms, with or withOUT_MD5
 ...
 * MD5_u32plus.  In practice, this problem may occur if these MD5 rOUT_MD5ines are
 * inlined into a calling function, or with future and dangerously advanced
 * link-time optimizations.  For the time being, keeping these MD5 rOUT_MD5ines in
