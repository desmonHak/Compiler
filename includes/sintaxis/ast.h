...
typedef struct name_value
{
    ...
    enum
    {
        ...
        valor_nodo_ast,
        valor_string,
        valor_auto // si se da este valor, se reserva memoria dinamica
                   // pues supone que se usara para almacenar datos de distintos tipos
    } type_data_values;
    /*struct status_c {
        uint8_t is_static_type_data:1; // es de tipo estatica, es 1, si es de tipo dinamico, 0
